...
namespace app
{
    ...
    public sealed partial class App : Application
    {
        ...
        public App()
        {
            ...
            this.InitializeContactStorage();
        }

        private void InitializeContactStorage(){
            var store = Windows.Storage.ApplicationData.Current.LocalSettings;
            if(!store.Values.ContainsKey("ContactList")){
                store.Values.Add("ContactList", Newtonsoft.Json.JsonConvert.SerializeObject(new List<Contact>()));
            }
        }
